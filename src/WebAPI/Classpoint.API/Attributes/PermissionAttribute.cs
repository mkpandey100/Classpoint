...
namespace ClassPoint.API.Attributes;
...
public class PermissionAttribute : TypeFilterAttribute
{
    ...
    public class ClaimRequirementFilter(Claim[] claims, IDapperRepository dapper, IApplicationDbContext dbContext) : IAsyncActionFilter
    {
        private readonly Claim[] _claims = claims;
